...
let nodetext = document.createTextNode("prakash")
nodeElement.appendChild(nodetext)
document.getElementById("unList").appendChild(nodeElement);
...
function myFunction(){
    ...
    let nextElement= document.createTextNode(humanize(i))
    i++
    newElement.appendChild(nextElement)
    document.getElementById("mycontant").appendChild(newElement);
}
